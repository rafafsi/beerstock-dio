...
import com.digitalinnovation.beerstock.beerstock.dto.request.QuantityDTO;
...
public class BeerControllerTest {
    ...
    @Test
    void whenGETListWithBeerIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();

        //when
        when(beerService.listAll()).thenReturn((BeerDTO) Collections.singletonList(beerDTO));
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH)
                ...
                .andExpect((ResultMatcher) jsonPath("$[0].type", is(beerDTO.getType())));
    }

    @Test
    void whenGETListWithoutBeerIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    void whenDELETEIsCalledWithValidIdThenNoContentStatusIsReturned() throws Exception {
        ...
        //then
        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH + "/" + beerDTO.getId())
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void whenDELETEIsCalledWithInValidIdThenNoFoundStatusIsReturned() throws Exception {
        ...
        //then
        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH + "/" + INVALID_BEER_ID)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }

    @Test
    void whenPATCHIsCalledToIncrementThenRespondWithOkStatus() throws Exception, BeerStockExcededException {
    ...
    @Test
    void whenPATCHIsCalledToIncrementWithQuantityGreaterThanAmountLeftThenRespondWithBadRequestStatus() throws Exception, BeerStockExcededException {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(41)
                .build();
    ...
    @Test
    void whenPATCHIsCalledToIncrementWithQuantityGreaterThanMaxThenRespondWithBadRequestStatus() throws Exception, BeerStockExcededException {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(51)
                .build();
    ...
    @Test
    void whenPATCHIsCalledToIncrementWithInvalidBeerIdThenRespondWithNotFoundStatus() throws Exception, BeerStockExcededException {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(51)
                .build();
